...
import { ArrowRight, Sparkles, Terminal, Check, Copy, Zap, Shield, Users } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ top: '-180px', left: '50%', transform: 'translateX(-50%)', opacity: 0.5 }}
      />
      <div
        className="ambient-glow-purple"
        style={{ top: '-80px', right: '-100px', opacity: 0.35 }}
      />

      <div className="cl-container relative z-10 flex flex-col items-center text-center">
        {/* Release Pill Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-semibold shadow-lg shadow-emerald-500/5 backdrop-blur-md mb-6">
        ...
        {/* Hero Title */}
        <h1 className="typo-hero max-w-4xl text-white tracking-tight my-4">
          Your Entire Dev Environment.{' '}
          <span className="gradient-text-emerald block sm:inline mt-1 sm:mt-0">In The Cloud.</span>
        </h1>

        {/* Hero Subtitle */}
        <p className="typo-body-lg mt-5 mb-8 max-w-2xl text-slate-300 font-normal">
        ...
        <div className="flex items-center gap-3 px-4 py-2 rounded-xl bg-slate-900/90 border border-white/10 text-xs font-mono text-slate-300 backdrop-blur-md mb-12 shadow-xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 w-full max-w-3xl pt-8 border-t border-white/10">
          <div className="flex flex-col items-center p-3 rounded-xl bg-slate-900/50 border border-white/5">
