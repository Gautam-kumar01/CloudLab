        ...
        <section className="hero-section">
          ...
          <div className="site-container hero-section__inner">
            <div className="hero-copy">
              ...
              <div className="hero-copy__actions"><Link href="/sign-up" className="button button--primary button--large">Start building free <ArrowRight size={17} /></Link><a href="#workspace" className="button button--ghost button--large"><span className="button-play"><Play size={12} fill="currentColor" /></span> See how it works</a></div>
