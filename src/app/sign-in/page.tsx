    ...
    <div className="flex flex-col h-screen w-full justify-center items-center" style={{ background: 'var(--bg-primary)' }}>
      <div style={{ width: '100%', maxWidth: '400px', padding: '40px', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-color)', boxShadow: '0 20px 50px rgba(0, 0, 0, 0.5)' }}>
        ...
        <div className="flex flex-col items-center" style={{ marginBottom: '32px' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginTop: '8px' }}>Log in to access your workspaces</p>
        </div>
        ...
        <div className="flex flex-col" style={{ gap: '20px' }}>
          ...
          <button disabled style={{ marginTop: '8px', padding: '12px', background: 'var(--bg-tertiary)', color: 'var(--text-secondary)', borderRadius: '6px', fontWeight: 600, textAlign: 'center', cursor: 'not-allowed', border: '1px solid var(--border-color)' }}>
            Email Login Disabled (Use GitHub)
          </button>
        </div>
        ...
        >
          <button type="submit" className="flex items-center justify-center w-full" style={{ gap: '12px', padding: '12px', marginTop: '16px', background: 'var(--bg-tertiary)', border: '1px solid var(--border-color)', borderRadius: '6px', color: 'var(--text-primary)', fontWeight: 500, transition: 'background 0.2s', cursor: 'pointer' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '24px', fontSize: '0.85rem', color: 'var(--text-secondary)' }}>
          Don't have an account? <Link href="/sign-up" style={{ color: 'var(--text-primary)', fontWeight: 600 }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
